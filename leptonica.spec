...
Source0  : https://github.com/DanBloomberg/leptonica/releases/download/1.85.0/leptonica-1.85.0.tar.gz
...
%prep
%setup -q -n leptonica-1.85.0
cd %{_builddir}/leptonica-1.85.0
pushd ..
cp -a leptonica-1.85.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729120022
